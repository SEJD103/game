...
"TRVSG's house","Coda's house","mysterious well","graveyard","Troll's hideout","the monster's lair","friendly elf traders",
...
# I added a bit of code to stop the player being able to explore when confronted
        if self.status != "confronted":
            ...
            if randint(0,1) == 1:
                ...
                # I removed a line of code here that double printed the "what do you want to do" line
                self.status = "confronted"
        else:
            print("you cannot explore, you are in combat!")
